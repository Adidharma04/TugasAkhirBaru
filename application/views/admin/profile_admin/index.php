<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Profile <?php echo ucfirst($this->session->userdata('sess_name')) ?></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card bg-light">
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                            ...
                            <a href="<?= base_url() . 'admin/pegawai/edit/' . $sess_id_pegawai ?>" class="btn btn-sm btn-primary">
                                <i class="fas fa-user"></i> Edit Profil
                            </a>
                            <a href="<?= base_url() . 'admin/pegawai/password' ?>" class="btn btn-sm btn-primary">
